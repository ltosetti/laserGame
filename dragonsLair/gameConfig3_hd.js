            ...
            (function(index){                
                if (!success && !pressed && this.videoEl.currentTime > this.gd.moveArrayCheckStart[index] && this.videoEl.currentTime < this.gd.moveArrayCheckEnd[index] && !this.gd.stageActive[index] && !this.gd.stageComplete[index]){
                    ...
                    this.current = [
                        ...
                        //this.current[3] =this.gd.moveArrayfailed1Start
                        //this.current[4] =this.gd.moveArrayfailed1End
                        //this.current[5] =this.gd.moveArrayfailed1Start
                        //this.current[6] =this.gd.moveArrayfailed1End
                    ]; 
                    //this.current
                    if (index > 0){
                        this.prev = [
