...
---------- mistake 2.
------------ load mistake 2 scene.
------------ at the end of scene reload the miss checkpoint.       
......

*/
function GameData(options, options2, options3, options4, options5, options6, options7, options8, options9, options10, options11, options12, options13, gameCfg){
    _this = this;
    ...
    this.stages = [options, options2, options3, options4, options5, options6, options7, options8, options9, options10, options11,options12,options13];     
...
GameData.prototype.render = function(){
    ...
    */
    ...
    if (this.isMsIe || this.isMsEdge){
        //this.videoEl.src = "EshsAurunmilla.m4v";
    }        
...
GameData.prototype.selectLevel = function(el, options,l){
    el.onclick = function(){
        ...
        if (l == 0){
            ...
            .staggerTo(allBtn, 0.2,{autoAlpha:0.4},0.1)
        ...
        for(var i = 0; this.checkPoint.length > i; i++){  
            ...
            if (this.videoEl.currentTime > this.checkPoint[i].endTime && this.checkPoint[i].active && !this.checkPoint[i].complete) { 
                ...
                */
                ...
                if (success){
                    ...
                    this.livesEl.innerHTML = this.livesEl.innerHTML -1;
                    console.log("no move");
                } /*else if (success && this.checkPoint[i].jumpTo != undefined){  
                    this.checkPoint[i].active = false; 
                    console.log("success");
                    this.checkPoint[i].complete = true;                    
                    //this.scoreEl.innerHTML = parseInt(this.scoreEl.innerHTML)+this.score;
                    ...
                    this.stageSuccesMove = this.stageSuccesMove+1;
                    this.videoEl.pause();
                    this.videoEl.currentTime = this.checkPoint[i].jumpTo;
                    setTimeout(function(){
                    this.videoEl.play();
                    }.bind(this), 2000);
                    //break;                
            ...
            if (wrongTimeEnd != undefined && this.videoEl.currentTime > wrongTimeEnd && !this.checkPoint[i].complete){  
                if (this.lives != 0){
                    ...
                    } else if (this.checkPoint[i-1].jumpTo != undefined) {
                        this.videoEl.pause();
                        this.videoEl.currentTime = this.checkPoint[i-1].jumpTo;                       
                        setTimeout(function(){                           
                            this.videoEl.play();
                        }.bind(this),1500);
                    } else {
                    ...
                    //this.videoEl.pause();
                    this.videoEl.currentTime = 1415.7; 
                    setTimeout(function(){
                        this.videoEl.load();
                    }.bind(this),7000);
                    var cStage;
                ...
                if (this.videoEl.currentTime > this.checkPoint[i].endStage && this.checkPoint[i].complete){                   
                    ...
                    for (var a = 0; this.btnStage.length > 0; a++){
                        if(this.btnStage[a].getAttribute("data-active") != "true" && this.btnStage[a].getAttribute("data-id") != "last") {                            
                            ...
                            //this.videoEl.currentTime = this.stage[this.stage].newStage;
                            //this.videoEl.play();
                            break;
                        } else if (this.btnStage[a].getAttribute("data-id") == "last" && this.btnStage[a].getAttribute("data-active") != "true") {                           
                            //this.btnStageStatusComplete(a); 
                            //this.videoEl.currentTime = this.checkPoint[i+1].newStage;
                            //this.videoEl.play();
            ...
            if (success && this.checkPoint[i].jumpTo != undefined && this.checkPoint[i].active){
                console.log("jumpTo");
                //this.videoEl.pause();
                var goto = this.checkPoint[i].jumpTo;
                var delay = this.checkPoint[i].jumpToDelay
                setTimeout(function(){
                    this.videoEl.pause();
                    this.videoEl.currentTime = goto;
                    setTimeout(function(){
                        this.videoEl.play();
                    }.bind(this), 1500);
            ...
            /*if (success && this.checkPoint[i].jumpTo != undefined){            
                this.videoEl.pause();
                this.videoEl.currentTime = this.checkPoint[i].jumpTo;
                //setTimeout(function(){
                    this.videoEl.play();
...
GameData.prototype.gameRecap = function(stage, stagesComplete, options){
    ...
    var recapBody = document.createElement("div");
        ...
        recapBody.innerHTML = 
            ...
            "<h1 style=''>Game Complete:  "+ parseFloat((stagesComplete/this.btnStage.length)*100)+"%"+"</h1>";            
...
======================================================================================================================================
*/
var gameData = new GameData(gameSheet,gameSheet2,gameSheet3, gameSheet4, gameSheet5, gameSheet6, gameSheet7, gameSheet8, gameSheet9, gameSheet10, gameSheet11, gameSheet12, gameSheet13, gameCfg);       
